...
-- Schema getpoc
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `getpoc` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ;
USE `getpoc` ;

-- -----------------------------------------------------
-- Table `getpoc`.`tb_area`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `getpoc`.`tb_area` (
  `ID` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `getpoc`.`tb_discipline`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `getpoc`.`tb_discipline` (
...
-- -----------------------------------------------------
-- Table `getpoc`.`tb_keyword`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `getpoc`.`tb_keyword` (
...
-- Table `getpoc`.`tb_pdf`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `getpoc`.`tb_pdf` (
  `ID` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `getpoc`.`tb_user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `getpoc`.`tb_user` (
  `ID` VARCHAR(100) NOT NULL,
...
-- Table `getpoc`.`tb_poc`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `getpoc`.`tb_poc` (
  `ID` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `getpoc`.`tb_poc_has_keyword`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `getpoc`.`tb_poc_has_keyword` (
  ...
  CONSTRAINT `fk_TB_POC_has_Keyword_keyeword1`
    ...
    REFERENCES `getpoc`.`tb_keyword` (`ID`),
  CONSTRAINT `TB_fk_POC_has_Keyword_POC1`
    FOREIGN KEY (`TB_POC_ID`)
    REFERENCES `getpoc`.`tb_poc` (`ID`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
-- Table `getpoc`.`tb_student`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `getpoc`.`tb_student` (
  `Email` VARCHAR(100) NOT NULL,
...
-- -----------------------------------------------------
-- Table `getpoc`.`tb_teacher_co-advises_poc`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `getpoc`.`tb_teacher_co-advises_poc` (
  ...
  CONSTRAINT `fk_TB_Teacher_Co-advises_POC_teacher1`
    ...
    REFERENCES `getpoc`.`tb_teacher_id` (`TB_User_ID`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
-- Table `getpoc`.`tb_teacher_has_discipline`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `getpoc`.`tb_teacher_has_discipline` (
  ...
  CONSTRAINT `fk_TB_Teacher_has_Discipline_discipline1`
    ...
    REFERENCES `getpoc`.`tb_discipline` (`ID`),
...
-- -----------------------------------------------------
-- Table `getpoc`.`tb_user_manages_user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `getpoc`.`tb_user_manages_user` (
