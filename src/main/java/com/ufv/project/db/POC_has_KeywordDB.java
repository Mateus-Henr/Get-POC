...
import com.ufv.project.db.KeywordDB.*;
...
public class POC_has_KeywordDB {
    ...
    public static final String QUERY_KEYWORDS_BY_POC_ID = "SELECT * FROM " + TABLE_POC_HAS_KEYWORD + " WHERE " + COLUMN_POC_HAS_KEYWORD_POC_ID + " = ?";

    public static final String QUERY_ALL_POC_HAS_KEYWORD = "SELECT * FROM " + TABLE_POC_HAS_KEYWORD;
